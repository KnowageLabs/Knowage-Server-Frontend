    ...
    methods: {
        ...
        getFormattedParameters() {
            ...
            Object.keys(this.parameters.filterStatus).forEach((key: any) => {
                ...
                if (!parameter.multivalue) {
                    parameters.push({ urlName: parameter.urlName, value: parameter.parameterValue?.[0] ? parameter.parameterValue[0].value : '', description: parameter.parameterValue?.[0] ? parameter.parameterValue[0].description : '' })
                } else {
