            ...
            <div v-for="(parameter, index) of selectedDataset.parameters" :key="index" class="p-fluid p-formgrid p-grid p-mx-2 p-mt-2">
                ...
                <div class="p-field p-d-flex p-col-4">
                    <span class="p-float-label kn-flex">
                        <Chips v-if="parameter.modelType === 'static' && parameter.multiValue" v-model="parameter.value" class="kn-border-none" />
                        <InputText v-else id="label" v-model="parameter.value" class="kn-material-input" type="text" />
