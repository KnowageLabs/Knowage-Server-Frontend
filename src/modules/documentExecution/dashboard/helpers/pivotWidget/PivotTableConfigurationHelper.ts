...
export const getFormattedConfiguration = (widget: any) => {
    ...
    return {
        ...
        rows: { grandTotal: widgetConfig.calculatetotalsonrows ?? false, grandTotalLabel: widgetConfig.rowtotalLabel, subTotal: widgetConfig.calculatesubtotalsonrows ?? false, subTotalLabel: widgetConfig.rowsubtotalLabel, rowsExpanded: false } as IPivotRowsConfiguration,
        columns: { grandTotal: widgetConfig.calculatetotalsoncolumns ?? false, grandTotalLabel: widgetConfig.columntotalLabel, subTotal: widgetConfig.calculatesubtotalsoncolumns ?? false, subTotalLabel: widgetConfig.columnsubtotalLabel, colsExpanded: false } as IPivotColumnsConfiguration,
