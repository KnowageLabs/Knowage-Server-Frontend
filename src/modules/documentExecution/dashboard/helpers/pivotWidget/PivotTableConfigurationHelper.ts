...
export const getFormattedConfiguration = (widget: any) => {
    ...
    return {
        ...
        rows: { grandTotal: widgetConfig.calculatetotalsonrows, grandTotalLabel: widgetConfig.rowtotalLabel, subTotal: widgetConfig.calculatesubtotalsonrows, subTotalLabel: widgetConfig.rowsubtotalLabel, rowsExpanded: false } as IPivotRowsConfiguration,
        columns: { grandTotal: widgetConfig.calculatetotalsoncolumns, grandTotalLabel: widgetConfig.columntotalLabel, subTotal: widgetConfig.calculatesubtotalsoncolumns, subTotalLabel: widgetConfig.columnsubtotalLabel, colsExpanded: false } as IPivotColumnsConfiguration,
