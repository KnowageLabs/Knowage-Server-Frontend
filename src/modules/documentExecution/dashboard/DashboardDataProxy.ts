...
export const addSelectionsToData = (dataToSend: any, propWidget: IWidget, datasetLabel: string, initialCall: boolean, selections: ISelection[], associativeResponseSelections: any) => {
    if (associativeResponseSelections && Object.keys(associativeResponseSelections).length > 0) dataToSend.selections = getFormattedAssociativeSelections(associativeResponseSelections, datasetLabel)
