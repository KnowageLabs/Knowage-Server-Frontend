<template>
    <div class="pivot-widget-container p-d-flex p-d-row kn-flex">CE PIVOT</div>
</template>
...
import { getColumnConditionalStyles, getWidgetStyleByType, stringifyStyleProperties } from './cePivotWidgetConditionalHelper'
