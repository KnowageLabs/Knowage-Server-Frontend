<template>
    <ul class="active-selections-list">
        <li v-for="(selection, index) of activeSelections" :key="index" :style="getRowStyle(index)">
            ...
            <Button v-tooltip.left="$t('common.delete')" icon="fas fa-trash-alt" class="p-button-text p-button-rounded p-button-plain" :disabled="editorMode" data-test="delete-button" @click="deleteSelection(selection)" />
        </li>
    </ul>
</template>
