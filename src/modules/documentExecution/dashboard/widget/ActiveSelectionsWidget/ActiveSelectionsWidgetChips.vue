<template>
    <div class="active-selections-chip">
        ...
        <Button v-if="!activeSelection.locked" v-tooltip.left="$t('common.delete')" icon="fas fa-trash-alt" class="p-button-text p-button-rounded p-button-plain" :disabled="editorMode" data-test="delete-button" @click.stop="deleteSelection()" />
    </div>
</template>
