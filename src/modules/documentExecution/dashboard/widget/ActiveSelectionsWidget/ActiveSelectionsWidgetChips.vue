<template>
    <div class="active-selections-chip">
        ...
        <Button v-tooltip.left="$t('common.delete')" icon="fas fa-trash-alt" class="p-button-text p-button-rounded p-button-plain" :disabled="editorMode || activeSelection.locked" data-test="delete-button" @click.stop="deleteSelection()" />
    </div>
</template>
