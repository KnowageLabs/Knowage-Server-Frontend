<template>
    <Dialog class="kn-dialog--toolbar--primary" :visible="visible" :header="$t('dashboard.widgetEditor.searchInTableWidget')" :style="descriptor.dialogStyle" :closable="false" modal>
        <div v-if="widget" class="p-formgrid p-grid">
            ...
            <div class="p-field p-float-label p-col-12">
                <MultiSelect v-model="searchColumns" :options="columnOptions" class="kn-width-full" option-label="columnName" option-value="columnName"> </MultiSelect>
