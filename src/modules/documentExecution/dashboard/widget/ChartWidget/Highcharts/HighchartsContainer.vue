...
import { applyLegacyCockpitAutoAxisExtremes, formatActivityGauge, formatBubble, formatHeatmap, formatRadar, formatSplineChart, formatPictorialChart, formatStreamgraphChart, formatPackedBubble, formatVariables, normalizeTooltipSettings, normalizeYAxisLabelsAlignment } from './HighchartsModelFormattingHelpers'
...
export default defineComponent({
    ...
    methods: {
        ...
        getModelForRender() {
            ...
            applyLegacyCockpitAutoAxisExtremes(formattedChartModel)
