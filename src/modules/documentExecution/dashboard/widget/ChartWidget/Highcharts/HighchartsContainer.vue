...
export default defineComponent({
    ...
    methods: {
        ...
        updateChartModel() {
            ...
            this.widgetModel.settings.chartModel.setData(dataToUse, tempWidgetModel, this.variables, this.drillLevel)
        ...
        async fetchDataWithMeasures(measureNames: string[]) {
            try {
                ...
                showDashboardWidgetError(this.widgetModel, error ? error.message : 'Failed to fetch data for selected measures')
            }
        },
        playSonify() {
