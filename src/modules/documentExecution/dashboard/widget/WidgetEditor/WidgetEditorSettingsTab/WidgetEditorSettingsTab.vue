<template>
    <div v-if="propWidget" class="p-d-flex kn-flex">
        ...
        <KnHint v-if="!selectedSetting && !isSearchActive" class="p-as-center" :title="'common.settings'" :hint="'dashboard.widgetEditor.settings.hint'"></KnHint>
        <TableWidgetSettingsContainer v-if="(selectedSetting || isSearchActive) && propWidget.type === 'table'" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId"></TableWidgetSettingsContainer>
        <SelectorWidgetSettingsContainer v-else-if="(selectedSetting || isSearchActive) && propWidget.type === 'selector'" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId"></SelectorWidgetSettingsContainer>
        <SelectionsWidgetSettingsContainer v-else-if="(selectedSetting || isSearchActive) && propWidget.type === 'selection'" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId"></SelectionsWidgetSettingsContainer>
        <HTMLWidgetSettingsContainer v-else-if="(selectedSetting || isSearchActive) && propWidget.type === 'html'" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId" :prop-gallery-items="galleryItems" @galleryItemSelected="onGalleryItemSelected"></HTMLWidgetSettingsContainer>
        <TextWidgetSettingsContainer v-else-if="(selectedSetting || isSearchActive) && propWidget.type === 'text'" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId"></TextWidgetSettingsContainer>
        <HighchartsWidgetSettingsContainer v-else-if="(selectedSetting || isSearchActive) && propWidget.type === 'highcharts' && user.enterprise" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId" :descriptor="descriptor"></HighchartsWidgetSettingsContainer>
        <ChartJSWidgetSettingsContainer v-else-if="(selectedSetting || isSearchActive) && propWidget.type === 'chartJS'" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId"></ChartJSWidgetSettingsContainer>
        <ImageWidgetSettingsContainer v-else-if="(selectedSetting || isSearchActive) && propWidget.type === 'image'" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId" @settingSelected="$emit('settingChanged', $event)"></ImageWidgetSettingsContainer>
        <CustomChartWidgetSettingsContainer v-else-if="(selectedSetting || isSearchActive) && propWidget.type === 'customchart'" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId" :custom-chart-gallery-prop="customChartGallery" @galleryItemSelected="onGalleryItemSelected"></CustomChartWidgetSettingsContainer>
        <PivotTableWidgetSettingsContainer v-else-if="(selectedSetting || isSearchActive) && propWidget.type === 'static-pivot-table'" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId"></PivotTableWidgetSettingsContainer>
        <DiscoveryWidgetSettingsContainer v-else-if="(selectedSetting || isSearchActive) && propWidget.type === 'discovery'" class="kn-flex" :widgetModel="propWidget" :selectedSetting="selectedSetting" :datasets="datasets" :selectedDatasets="selectedDatasets" :variables="variables" :dashboardId="dashboardId"></DiscoveryWidgetSettingsContainer>
        <MapWidgetSettingsContainer v-else-if="(selectedSetting || isSearchActive) && propWidget.type === 'map'" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId" :layers="layers"></MapWidgetSettingsContainer>
        <cePivotTableWidgetSettingsContainer v-else-if="(selectedSetting || isSearchActive) && propWidget.type === 'ce-pivot-table'" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId"></cePivotTableWidgetSettingsContainer>
        <PythonWidgetSettingsContainer v-else-if="(selectedSetting || isSearchActive) && propWidget.type === 'python'" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :dashboard-id="dashboardId" :prop-gallery-items="galleryItems" @galleryItemSelected="onGalleryItemSelected"></PythonWidgetSettingsContainer>
        <SpacerWidgetSettingsContainer v-else-if="(selectedSetting || isSearchActive) && propWidget.type === 'spacer'" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId"></SpacerWidgetSettingsContainer>
        <!-- </div> -->
    </div>
</template>
