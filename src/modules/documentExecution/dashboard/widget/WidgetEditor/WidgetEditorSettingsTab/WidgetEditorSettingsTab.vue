<template>
    <div v-if="propWidget" class="p-d-flex kn-flex">
        ...
        <SelectorWidgetSettingsContainer v-else-if="selectedSetting && propWidget.type === 'selector'" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId"></SelectorWidgetSettingsContainer>
        <SelectionsWidgetSettingsContainer v-else-if="selectedSetting && propWidget.type === 'selection'" class="kn-flex" :widget-model="propWidget" :selected-setting="selectedSetting" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId"></SelectionsWidgetSettingsContainer>
