<template>
    <div v-show="widgetModel">
        <SelectionsWidgetSettingsAccordion v-show="selectedSetting || isSearchActive" :widget-model="widgetModel" :settings="activeSettings" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId"></SelectionsWidgetSettingsAccordion>
    </div>
</template>
...
export default defineComponent({
    ...
    components: { SelectionsWidgetSettingsAccordion },
    props: {
