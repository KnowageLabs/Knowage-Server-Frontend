<template>
    <div v-show="widgetModel">
        <SelectorWidgetSettingsAccordion v-show="selectedSetting || isSearchActive" :widget-model="widgetModel" :settings="activeSettings" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId"></SelectorWidgetSettingsAccordion>
    </div>
</template>
