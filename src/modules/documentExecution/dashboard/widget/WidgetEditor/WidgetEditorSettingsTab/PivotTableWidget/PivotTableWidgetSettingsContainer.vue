<template>
    <div v-show="widgetModel">
        <PivotTableSettingsAccordion v-show="selectedSetting || isSearchActive" :widgetModel="widgetModel" :settings="activeSettings" :datasets="datasets" :selectedDatasets="selectedDatasets" :variables="variables" :dashboardId="dashboardId"></PivotTableSettingsAccordion>
    </div>
</template>
...
import PivotTableSettingsAccordion from './PivotTableSettingsAccordion.vue'
