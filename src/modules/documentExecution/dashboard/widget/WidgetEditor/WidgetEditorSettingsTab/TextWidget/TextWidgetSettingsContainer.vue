<template>
    <div v-show="widgetModel">
        <TextWidgetSettingsAccordion v-show="selectedSetting || isSearchActive" :widget-model="widgetModel" :settings="activeSettings" :datasets="datasets" :selected-datasets="selectedDatasets" :variables="variables" :dashboard-id="dashboardId"></TextWidgetSettingsAccordion>
    </div>
</template>
...
import TextWidgetSettingsAccordion from './TextWidgetSettingsAccordion.vue'

export default defineComponent({
    name: 'text-widget-settings-container',
    components: { TextWidgetSettingsAccordion },
    props: {
