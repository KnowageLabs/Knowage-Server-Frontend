...
export default defineComponent({
    ...
    computed: {
        allSeriesOptionEnabled() {
            return this.model && !['pie', 'solidgauge', 'sunburst', 'treemap', 'dependencywheel', 'sankey', 'pictorial', 'funnel', 'dumbbell', 'streamgraph'].includes(this.model.chart.type)
        },
        formattingSectionAvailable() {
            return this.model && ['pie', 'gauge', 'solidgauge', 'radar', 'area', 'bar', 'column', 'line', 'scatter', 'bubble', 'sunburst', 'treemap', 'dependencywheel', 'sankey', 'pictorial', 'funnel', 'dumbbell', 'streamgraph'].includes(this.model.chart.type)
        },
        precisionAvailable() {
            return this.model && ['pie', 'gauge', 'solidgauge', 'radar', 'area', 'bar', 'column', 'line', 'scatter', 'bubble', 'dumbbell', 'streamgraph'].includes(this.model.chart.type)
        },
        scaleVisible() {
            return this.model && ['pie', 'gauge', 'solidgauge', 'radar', 'area', 'bar', 'column', 'line', 'scatter', 'bubble', 'dumbbell', 'streamgraph'].includes(this.model.chart.type)
        },
        ...
        styleToolbarVisible() {
            return this.model && ['pie', 'gauge', 'radar', 'area', 'bar', 'column', 'line', 'scatter', 'bubble', 'sunburst', 'treemap', 'dependencywheel', 'sankey', 'pictorial', 'funnel', 'dumbbell', 'streamgraph'].includes(this.model.chart.type)
        },
