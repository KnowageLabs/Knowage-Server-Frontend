...
export default defineComponent({
    ...
    computed: {
        ...
        formattingSectionAvailable() {
            return this.model && ['pie', 'gauge', 'solidgauge', 'radar', 'area', 'bar', 'column', 'line'].includes(this.model.chart.type)
        },
        percentageAvailable() {
        ...
        styleToolbarVisible() {
            return this.model && ['pie', 'gauge', 'radar', 'area', 'bar', 'column', 'line'].includes(this.model.chart.type)
        },
