            ...
            <div class="p-col-12 p-grid p-p-0" :draggable="!conditionalStylesDisabled" @dragstart.stop="onDragStart($event, index)">
                ...
                <div class="p-grid p-col-10 p-ai-center">
                    <div class="p-sm-12 p-md-6 p-lg-6 p-d-flex p-flex-column">
                        ...
                        <Dropdown v-model="conditionalStyle.target" class="kn-material-input" :options="widgetModel.columns.filter((column) => column.fieldType === 'MEASURE') ?? []" option-label="alias" option-value="id" :disabled="conditionalStylesDisabled"> </Dropdown>
                    </div>
