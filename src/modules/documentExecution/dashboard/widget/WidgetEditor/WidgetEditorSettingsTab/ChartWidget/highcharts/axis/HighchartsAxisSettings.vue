<template>
    <div v-if="axisModel" class="p-grid p-jc-center p-ai-center p-p-4">
        ...
        <div class="p-col-12 p-d-flex p-flex-column" :class="{ 'p-md-3': chartType === 'heatmap', 'p-md-6': ['radar', 'column', 'line'].includes(chartType) }">
        ...
        <div class="p-col-12 p-d-flex p-flex-column kn-flex p-p-2" :class="{ 'p-md-3': chartType === 'heatmap', 'p-md-6': ['radar', 'column', 'line'].includes(chartType) }">
