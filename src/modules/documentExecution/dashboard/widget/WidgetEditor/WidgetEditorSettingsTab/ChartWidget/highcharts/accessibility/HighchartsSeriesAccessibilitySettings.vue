...
export default defineComponent({
    ...
    computed: {
        allSeriesOptionEnabled() {
            return this.model && !['pie', 'solidgauge', 'sunburst', 'treemap', 'dependencywheel', 'sankey', 'pictorial', 'funnel', 'dumbbell', 'streamgraph', 'packedbubble', 'waterfall'].includes(this.model.chart.type)
        }
    },
    watch: {
        propWidgetModel() {
