<template>
    ...
    <div v-else-if="widget" class="p-d-flex kn-flex kn-overflow">
        ...
        <HighchartsDataContainer v-else-if="widget.type === 'highcharts' && isEnterprise" class="kn-flex model-div kn-overflow" :widget-model="propWidget" :selected-dataset="selectedDataset" :selected-dataset-columns="selectedDatasetColumns" :listDragActive="listDragActive" @selectedChartTypeChanged="onChartTypeChanged"></HighchartsDataContainer>
        <ChartJSDataContainer v-else-if="widget.type === 'chartJS'" class="kn-flex model-div kn-overflow p-mx-2 p-my-3" :widget-model="propWidget" :selected-dataset="selectedDataset" :selected-dataset-columns="selectedDatasetColumns" @selectedChartTypeChanged="onChartTypeChanged"></ChartJSDataContainer>
