...
const mapBaseLayerDefinitions: Record<IMapWidgetBaseLayerType, IMapWidgetBaseLayerDefinition> = {
    ...
    cartoLight: {
        ...
        url: `${import.meta.env.VITE_KNOWAGE_CONTEXT}/restful-services/2.0/map-tiles/carto/light/{z}/{x}/{y}.png`,
        options: {
            maxZoom: 20,
    ...
    cartoDark: {
        ...
        url: `${import.meta.env.VITE_KNOWAGE_CONTEXT}/restful-services/2.0/map-tiles/carto/dark/{z}/{x}/{y}.png`,
        options: {
            maxZoom: 20,
            attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://carto.com/">CARTO</a>'
        },
