...
export const addMissingMenuWidgetsConfiguration = (dashboard: IDashboard) => {
    if (!dashboard.configuration.menuWidgets) dashboard.configuration.menuWidgets = { showExcelExport: true, xlsxStyleEnabled: false, exportFileName: '', showScreenshot: true, showSelectionButton: true, enableWidgetMenu: true, enableChartChange: true, enableCaching: true, enableCustomHeader: false }
    ...
    if (dashboard.configuration.menuWidgets.exportFileName === undefined) dashboard.configuration.menuWidgets.exportFileName = ''
