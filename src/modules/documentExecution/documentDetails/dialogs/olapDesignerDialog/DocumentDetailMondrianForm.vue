...
export default defineComponent({
    ...
    methods: {
        ...
        async loadCubes() {
            ...
            await this.$http
                .get(import.meta.env.VITE_KNOWAGEWHATIF_CONTEXT + `/restful-services/1.0/designer/allcubes/${this.selectedMondrianSchema.currentContentId}?SBI_EXECUTION_ID=${this.sbiExecutionId}`)
