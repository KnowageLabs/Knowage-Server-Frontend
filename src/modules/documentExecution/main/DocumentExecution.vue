...
export default defineComponent({
    ...
    methods: {
        ...
        async loadExporters() {
            ...
            await this.$http.get(import.meta.env.VITE_RESTFUL_SERVICES_PATH + `2.0/exporters/config/${engineLabel}`).then((response: AxiosResponse<any>) => (this.exporters = response.data.exporters))
        },
