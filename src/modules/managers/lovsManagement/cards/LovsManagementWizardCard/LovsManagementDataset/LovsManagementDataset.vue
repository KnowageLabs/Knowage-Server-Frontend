...
export default defineComponent({
    ...
    methods: {
        async loadDatasets() {
            await this.$http.get(import.meta.env.VITE_KNOWAGE_CONTEXT + '/restful-services/1.0/datasets/datasetsforlov/').then((response: AxiosResponse<any>) => (this.datasets = response.data))
        },
        loadDataset() {
