...
export default defineComponent({
    ...
    methods: {
        async loadGlossary() {
            this.loading = true
            await this.$http
                .get(import.meta.env.VITE_KNOWAGE_CONTEXT + '/restful-services/1.0/glossary/listGlossary')
        ...
        async filterGlossaryTree() {
            ...
            this.timer = setTimeout(() => {
                this.loading = true
                this.$http
                    .get(import.meta.env.VITE_KNOWAGE_CONTEXT + `/restful-services/1.0/glossary/glosstreeLike?WORD=${this.searchWord}&GLOSSARY_ID=${this.selectedGlossaryId}`)
