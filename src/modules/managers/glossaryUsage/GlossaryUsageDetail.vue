    ...
    methods: {
        async loadNavigationItems(type: string, item: string) {
            ...
            const postData = {
                type: type,
                item: item,
                word: { selected: this.selectedWords, search: '', page: 1, GLOSSARY_ID: this.glossaryId },
                document: { selected: this.selectedDocuments, search: '', page: 1, GLOSSARY_ID: this.glossaryId },
                dataset: { selected: this.selectedDatasets, search: '', page: 1, GLOSSARY_ID: this.glossaryId },
                table: { selected: this.selectedTables, search: '', page: 1, GLOSSARY_ID: this.glossaryId },
                bness_cls: { selected: this.selectedBusinessClasses, search: '', page: 1, GLOSSARY_ID: this.glossaryId }
            }
            await this.$http
        ...
        async showDocumentInfo(document: iNavigationTableItem) {
            ...
            await this.$http.get(import.meta.env.VITE_KNOWAGE_CONTEXT + `/restful-services/1.0/documents/${document.label}`).then((response: AxiosResponse<any>) => (tempDocument = response.data))

            if (tempDocument) {
                await this.$http.get(import.meta.env.VITE_KNOWAGE_CONTEXT + `/restful-services/2.0/documents/${tempDocument.id}/roles`).then((response: AxiosResponse<any>) => (tempDocument.access = response.data))
        ...
        async loadDocuments() {
            ...
            this.loading = true
            await this.$http
                .get(import.meta.env.VITE_KNOWAGE_CONTEXT + '/restful-services/2.0/documents/listDocument?Page=1&ItemPerPage=&label=&scope=GLOSSARY')
                .then((response: AxiosResponse<any>) => {
        ...
        async loadDatasets() {
            ...
            this.loading = true
            await this.$http
                .get(import.meta.env.VITE_KNOWAGE_CONTEXT + '/restful-services/2.0/datasets/?asPagedList=true&Page=1&ItemPerPage=&label=')
                .then((response: AxiosResponse<any>) => {
                    response.data.item.forEach((el: any) => {
                        this.linkTableItems.push({
                            id: el.id.dsId,
        ...
        async loadBusinessClasses() {
            ...
            this.loading = true
            await this.$http
                .get(import.meta.env.VITE_KNOWAGE_CONTEXT + '/restful-services/1.0/metaBC/listMetaBC?Page=1&ItemPerPage=&label=')
                .then((response: AxiosResponse<any>) => {
        ...
        async loadTables() {
            ...
            this.loading = true
            await this.$http
                .get(import.meta.env.VITE_KNOWAGE_CONTEXT + '/restful-services/1.0/metaTable/listMetaTable?Page=1&ItemPerPage=&label=')
                .then((response: AxiosResponse<any>) => {
                    response.data.forEach((el: any) =>
                        this.linkTableItems.push({
                            id: el.tableId,
        ...
        async loadDocumentWords(document: iLinkTableItem) {
            this.loading = true
            await this.$http
                .get(import.meta.env.VITE_KNOWAGE_CONTEXT + `/restful-services/1.0/glossary/getDocumentInfo?DOCUMENT_ID=${document.id}`)
        ...
        loadDatasetInfo(dataset: any) {
            return this.$http.get(import.meta.env.VITE_KNOWAGE_CONTEXT + `/restful-services/1.0/glossary/getDataSetInfo?DATASET_ID=${dataset.id}&ORGANIZATION=${dataset.organization}`)
        },
        loadBusinessClassInfo(businessClass: any) {
            return this.$http.get(import.meta.env.VITE_KNOWAGE_CONTEXT + `/restful-services/1.0/glossary/getMetaBcInfo?META_BC_ID=${businessClass.id}`)
        },
        loadTableInfo(table: any) {
            return this.$http.get(import.meta.env.VITE_KNOWAGE_CONTEXT + `/restful-services/1.0/glossary/getMetaTableInfo?META_TABLE_ID=${table.id}`)
        },
