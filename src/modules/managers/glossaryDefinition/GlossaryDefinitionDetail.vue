...
export default defineComponent({
    ...
    methods: {
        ...
        async loadGlossaryList() {
            await this.$http.get(import.meta.env.VITE_KNOWAGE_CONTEXT + `/restful-services/1.0/glossary/listGlossary`).then((response: AxiosResponse<any>) => (this.glossaries = response.data))
        },
        async loadGlossary(glossaryId: number) {
            this.loading = true
            await this.$http
                .get(import.meta.env.VITE_KNOWAGE_CONTEXT + `/restful-services/1.0/glossary/getGlossary?GLOSSARY_ID=${glossaryId}`)
        ...
        async listContents(glossaryId: number, parent: any) {
            ...
            await this.$http.get(import.meta.env.VITE_KNOWAGE_CONTEXT + `/restful-services/1.0/glossary/listContents?GLOSSARY_ID=${glossaryId}&PARENT_ID=${parentId}`).then((response: AxiosResponse<any>) => {
        ...
        async filterGlossaryTree() {
            ...
            this.timer = setTimeout(() => {
                this.loading = true
                this.$http
                    .get(import.meta.env.VITE_KNOWAGE_CONTEXT + `/restful-services/1.0/glossary/glosstreeLike?WORD=${this.searchWord}&GLOSSARY_ID=${this.selectedGlossary?.GLOSSARY_ID}`)
        ...
        async saveWord(word: iWord, item: any) {
            ...
            await this.$http
                .post(import.meta.env.VITE_KNOWAGE_CONTEXT + '/restful-services/1.0/glossary/business/addContents', {
        ...
        async deleteNode(node: any) {
            ...
            const url = node.data.CONTENT_ID ? `/restful-services/1.0/glossary/business/deleteContents?CONTENTS_ID=${node.data.CONTENT_ID}` : `/restful-services/1.0/glossary/business/deleteContents?PARENT_ID=${node.parent.id}&WORD_ID=${node.data.WORD_ID}`
            let status = ''
            await this.$http
        ...
        async loadContent(contentId: number) {
            this.loading = true
            await this.$http
                .get(import.meta.env.VITE_KNOWAGE_CONTEXT + `/restful-services/1.0/glossary/getContent?CONTENT_ID=${contentId}`)
                .then(
        ...
        async saveContent(content: iContent) {
            ...
            await this.$http
                .post(import.meta.env.VITE_KNOWAGE_CONTEXT + '/restful-services/1.0/glossary/business/addContents', content)
                .then(
                    (response: AxiosResponse<any>) =>
                        (result = {
        ...
        async deleteGlossary() {
            this.loading = true
            await this.$http.post(import.meta.env.VITE_KNOWAGE_CONTEXT + `/restful-services/1.0/glossary/business/deleteGlossary?GLOSSARY_ID=${this.selectedGlossaryId}`).then(() => {
                this.store.setInfo({
        ...
        async handleSaveGlossary() {
            ...
            const url = this.selectedGlossary?.SaveOrUpdate ? '/restful-services/1.0/glossary/business/addGlossary' : '/restful-services/1.0/glossary/business/cloneGlossary'
            let tempData = {} as any
            await this.$http
                .post(import.meta.env.VITE_KNOWAGE_CONTEXT + url, this.selectedGlossary)
                .then((response: AxiosResponse<any>) => {
