<template>
    <Dialog class="kn-dialog--toolbar--primary createFolderDialog" :visible="visibility" footer="footer" :header="$t('managers.logManagement.createFolder')" :closable="false" modal>
        ...
        <div class="createFolderDialogContent">
            <span class="p-float-label">
                ...
                <label class="kn-material-input-label" for="label">{{ $t('managers.logManagement.foldernamePlaceholder') }}</label>
            </span>
        </div>
        <template #footer>
