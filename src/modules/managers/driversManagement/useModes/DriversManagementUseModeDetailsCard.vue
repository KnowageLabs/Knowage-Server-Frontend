        ...
        <div class="col-12 flex wrap">
          <div class="col-3 col-sm-12 col-md-4">
            <q-select
                ...
                :error-message="v$.mode.valueSelection.$invalid && v$.mode.valueSelection.$dirty ?
          ...
          <div v-show="mode.valueSelection === 'lov'" class="col-9 col-sm-12 col-md-8 row q-col-gutter-md">
            <div class="col-6 col-sm-12 col-md-6">
              <q-input
                  ...
                  $t('common.validation.required', { fieldName: $t('managers.driversManagement.useModes.lov') }) : null"
                  disable
                  :label="$t('managers.driversManagement.useModes.lov') + '*'"
                  autofocus>
            ...
            <div class="col-6 col-sm-12 col-md-6">
              <q-select
                  ...
                  :error-message="v$.mode.selectionType.$invalid && v$.mode.selectionType.$dirty ?
                  $t('common.validation.required', { fieldName: $t('managers.driversManagement.useModes.modality') }) : null"
        ...
        <div class="col-12 flex wrap">
          <div class="col-4 col-sm-12 col-md-4">
            <q-select
                ...
                :label="$t('managers.driversManagement.useModes.defaultValue') + '*'"
                autocomplete=""/>
          </div>
          ...
          <div v-show="selectedDefault === 'pickUp'" class="col-8 col-sm-12 col-md-8">
            <q-select
                ...
                :error-message="v$.mode.defaultFormula.$invalid && v$.mode.defaultFormula.$dirty ?
                $t('common.validation.required', { fieldName: $t('managers.driversManagement.useModes.selectDefaultFormula') }) : null"
        ...
        <div class="col-12 flex wrap">
          <div v-show="isDate" class="col-4 col-sm-12 col-md-4">
            <q-select
                ...
                :label="$t('managers.driversManagement.useModes.maxValue') + '*'"
                autocomplete=""/>
          </div>
...
import {QCard, QCardSection, QIcon, QInput, QSelect} from 'quasar'

export default defineComponent({
  name: 'detail-card',
  components: { QCard, QCardSection, QInput, QSelect, QIcon, LovsDialog },
  props: {
    selectedMode: {
      type: Object,
      required: false
