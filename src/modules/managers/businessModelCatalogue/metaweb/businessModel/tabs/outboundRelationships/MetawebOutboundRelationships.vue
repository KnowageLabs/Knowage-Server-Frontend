<template>
    <DataTable v-model:filters="filters" :value="inboundRelationships" class="p-datatable-sm kn-table p-ml-2" responsive-layout="stack" breakpoint="960px" :global-filter-fields="orDescriptor.globalFilterFields">
        <template #empty>
    ...
    <Dialog class="bsdialog" :style="bsDescriptor.style.bsDialog" :visible="inboundDialogVisible" :modal="true" :closable="false">
        ...
        <TableAssociator class="kn-flex" :source-array="simpleLeft" :target-array="simpleRight" :use-multiple-tables-from-same-source="false" @drop="onDrop" @relationshipDeleted="onDelete" />
