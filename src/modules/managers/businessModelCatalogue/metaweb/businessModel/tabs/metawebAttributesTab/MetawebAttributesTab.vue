...
export default defineComponent({
    ...
    methods: {
        ...
        async onRowReorder(event: any) {
            ...
            await this.$http
                .post(import.meta.env.VITE_KNOWAGEMETA_CONTEXT + `/restful-services/1.0/metaWeb/moveBusinessColumn`, postData)
        ...
        async deleteBusinessColumn(attribute: iBusinessModelColumn) {
            ...
            await this.$http
                .post(import.meta.env.VITE_KNOWAGEMETA_CONTEXT + `/restful-services/1.0/metaWeb/deleteBusinessColumn`, postData)
                .then((response: AxiosResponse<any>) => {
                    this.meta = applyPatch(this.meta, response.data).newDocument
        ...
        async saveUnusedFields(unusedColumns: any[]) {
            ...
            await this.$http
                .post(import.meta.env.VITE_KNOWAGEMETA_CONTEXT + `/restful-services/1.0/metaWeb/createBusinessColumn`, postData)
                .then((response: AxiosResponse<any>) => {
                    this.meta = applyPatch(this.meta, response.data).newDocument
