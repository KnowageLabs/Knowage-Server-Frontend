...
export default defineComponent({
    ...
    methods: {
        ...
        async openUpdateDialog() {
            ...
            await this.$http.get(import.meta.env.VITE_KNOWAGEMETA_CONTEXT + '/restful-services/1.0/metaWeb/updatePhysicalModel').then((response: AxiosResponse<any>) => (this.changedItem = response.data))
