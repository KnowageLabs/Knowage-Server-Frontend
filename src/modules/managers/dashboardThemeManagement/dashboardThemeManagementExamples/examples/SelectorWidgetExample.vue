...
export default defineComponent({
    ...
    data() {
        return {
            options: {
                rows: [
                    { id: 1, column_1: 'Q2', disabled: false },
                    { id: 2, column_1: 'Q3', disabled: false },
                    { id: 3, column_1: 'Q1', disabled: false },
                    { id: 4, column_1: 'Q4', disabled: false }
                ]
            } as any,
