...
export default defineComponent({
    ...
    methods: {
        ...
        addTarget() {
            if (this.perspective) {
                this.perspective.targets.push({ id: crypto.randomUUID(), name: 'New Target', status: 'GRAY', criterion: getDefaultCriterion(this.criterias), options: { criterionPriority: [] }, kpis: [], groupedKpis: [], new: true })
                this.$emit('touched')
                this.expanded = true
