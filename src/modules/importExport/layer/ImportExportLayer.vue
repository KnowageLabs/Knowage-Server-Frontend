<template>
    <div class="import-export-layers">
        ...
        <q-card class="p-d-flex p-flex-column kn-flex kn-overflow">
            <q-table class="sticky-header-table" ref="layersTable" v-model:selected="selectedItems[FUNCTIONALITY]" :rows="filteredLayers" :columns="columns" row-key="id" selection="multiple" :visible-columns="visibleColumns" virtual-scroll :pagination.sync="pagination" :rows-per-page-options="[0]" flat dense />
        </q-card>
    </div>
</template>
