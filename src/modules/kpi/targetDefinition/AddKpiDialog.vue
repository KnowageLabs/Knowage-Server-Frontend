    ...
    >
        <template #header>
            <Toolbar class="kn-toolbar kn-toolbar--primary p-p-0 p-m-0 p-col-12">
                ...
                <template #end>
                    <Button icon="pi pi-save" class="kn-button p-button-text p-button-rounded" data-test="save-button" @click="addKpi" />
                    <Button icon="pi pi-times" class="kn-button p-button-text p-button-rounded" data-test="close-button" @click="closeKpiDialog" />
                </template>
            </Toolbar>
        </template>
        <DataTable
